 ...
 * questions.
 */
import { ErrorCallback, FileFilter, FilePath, FileVisitor, ReadFileOptions, ReadResult } from '@ornorm/aspectT';
import { Blob } from 'buffer';
import { EventEmitter } from 'events';
import { EncodingOption, FSWatcher, Mode, ReadStream, StatsBase, WriteFileOptions, WriteStream } from 'fs';
 ...
 * @see StatsBase
 */
export declare class FileStats<T> implements StatsBase<T> {
     ...
     * @see FileStats
     */
    static get(filePath: string): FileStats<number>;
    /**
 ...
 * @since   aspectT1.0
 */
export declare class FileObject extends EventEmitter implements FilePath {
    /**
     ...
     * @see Mode
     */
    protected constructor(filePath: string | Blob | FileObject | FilePath | URL, child?: string, mode?: Mode | null);
    /**
     * Generates a unique name for a blob.
     *
     * @returns A string representing the unique blob name.
     */
    static get blobName(): string;
    /**
     ...
     */
    static get listRoots(): Array<FileObject>;
    /**
     ...
     */
    static get rootDirectories(): IterableIterator<FilePath>;
    /**
     ...
     * systems it is `';'`.
     */
    static get pathSeparatorChar(): number;
    /**
     ...
     * @see Blob
     */
    static blob(blob: Blob, options?: WriteFileOptions): Promise<FileObject>;
    /**
     ...
     */
    static decode(buffer: Buffer): FilePath;
    /**
     ...
     * @see URL
     */
    static directory(directoryPath: string | FileObject | FilePath | URL, attrs?: Mode, recursive?: boolean): FilePath;
    /**
     ...
     * @see Buffer
     */
    static encode(filePath: FilePath): Buffer;
    /**
     ...
     */
    static file(filePath: string | FileObject | URL, attrs?: Mode): FilePath;
    /**
     ...
     * @see FilePath
     */
    static filePath(filePath: string | FilePath): FilePath;
    /**
     * Constructs a new `FileObject` instance.
     *
     * @param filePath A string representing the file path, a `FileObject`
     ...
     * @see Mode
     */
    static get(filePath: string | Blob | FileObject | URL, child?: string, mode?: Mode | null): FileObject;
    /**
     ...
     */
    static join(...paths: Array<string | FilePath>): FilePath;
    /**
     ...
     * @throws TypeError If the path does not denote a directory.
     */
    static listPaths(directoryPath: string | FileObject | FilePath | URL): Array<FilePath>;
    /**
     ...
     */
    static of(parent: FileObject, child?: string): FileObject;
    /**
     * Creates a new `FileObject` instance from a parent pathname string
     * and a child pathname string.
     *
     ...
     * @param   child   The child pathname string
     */
    static path(parent: string, child: string): FileObject;
    /**
     ...
     */
    static pathName(prefix: string, suffix: string, dir?: FilePath): FilePath;
    /**
     ...
     * @see Readable
     */
    static readable(filePath: FileObject, readOptions?: ReadableOptions): Readable;
    /**
     ...
     */
    static tempDirectory(prefix: string, attrs?: Mode, recursive?: boolean): FilePath;
    /**
     ...
     * @see FilePath
     */
    static tempFile(prefix: string, suffix: string, directory?: FileObject): FilePath;
    /**
     ...
     * @throws TypeError If the generated file name is not a simple file name.
     */
    static tmpPath(dir: FilePath, prefix?: string, suffix?: string, createDirectory?: boolean, attrs?: Mode, recursive?: boolean): FilePath;
    /**
     ...
     * @see Writable
     */
    static writable(filePath: FileObject, writeOptions?: WritableOptions): Writable;
    protected static assertNotNul(input: string, c: string): void;
    protected static normalize(input: string, len?: number, off?: number): string;
    /**
     ...
     */
    compareTo(pathname: FileObject): number;
    /**
     ...
     *          <code>false</code> otherwise
     */
    equals(other: FileObject): boolean;
    /**
     * @inheritDoc
     */
     ...
     * @see FileListOptions
     */
    list(filter?: FileFilter, options?: FileListOptions | null): Array<string> | null;
    /**
     ...
     * @see FileFilter
     */
    listFiles(filter?: FileFilter): Array<FileObject> | null;
    /**
     ...
     * @see Buffer
     */
    read(options?: ReadFileOptions | null): Buffer;
    /**
     ...
     * @see ReadStream
     */
    readStream(options?: BufferEncoding, size?: number, readResult?: ReadResult): ReadStream;
    /**
     * @inheritDoc
     */
     ...
     *          <code>false</code> otherwise
     */
    renameTo(dest: FileObject): boolean;
    /**
     * @inheritDoc
     */
     ...
     * @see Blob
     */
    toBlob(type: string, options?: ReadFileOptions | null): Blob;
    /**
     * @inheritDoc
     */
     ...
     * @see FSWatcher
     */
    watch(callback: WatchHandler): FSWatcher;
    /**
     ...
     */
    write(data: string | NodeJS.ArrayBufferView, options?: WriteFileOptions): void;
    /**
     * Writes data to the file denoted by this abstract pathname.
     *
     ...
     * @see WriteStream
     */
    writeStream(data: Buffer | string, options?: BufferEncoding, callback?: ErrorCallback): WriteStream;
