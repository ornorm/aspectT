 ...
 */
export declare enum FileVisitResult {
    /**
     * Continue.
 ...
 * @see FileVisitor
 */
export declare class SimpleFileVisitor<T = string> implements FileVisitor<T> {
    /**
     * @inheritDoc
     */
    preVisitDirectory(dir: T, attrs: FileStats<T>): FileVisitResult;
    /**
     * @inheritDoc
     */
    visitFile(file: T, attrs: FileStats<T>): FileVisitResult;
    /**
     * @inheritDoc
     */
    visitFileFailed(file: T, exc?: Error): FileVisitResult;
     ...
     * @inheritDoc
     */
    postVisitDirectory(dir: T, exc?: Error): FileVisitResult;
}
